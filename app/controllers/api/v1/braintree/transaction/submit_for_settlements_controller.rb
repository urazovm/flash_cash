class Api::V1::Braintree::Transaction::SubmitForSettlementsController < ApplicationController
  respond_to :json

  def create
    result = Braintree::Transaction.submit_for_settlement(params.permit(:transaction_id)[:transaction_id])
